...
<body>
  ...
  <div class="container-fluid mt-3">
    ...
    <div class="card">
      <div class="card-header">
        <h2><?= $notice[0]->title ?><small class="float-end" style="text-align: right;">
                [<?= $notice[0]->date ?>]</small></h2>
      </div>
      </div>
      <br>
  ...
  <a class="btn btn-warning float-start" style="margin-left:12px; margin-top:12px;" href="index.php">Back to the list</a>
  <!-- end of editable -->
